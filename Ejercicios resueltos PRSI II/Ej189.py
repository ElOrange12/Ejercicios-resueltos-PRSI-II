...
#                                                                            #
#Proposito:Este progama desencripta mensajes.                                #
#                                                                            #
##############################################################################
...
for carácter in mensaje:
    ...
    if OrdC >= 65 and OrdC <= 90 or OrdC == 209:
        ...
        #Si el número es menor que 0 este "if" hará la equivalencia como si 
        #volviera a contar desde el final.
        if Lugar < 0:
            while Lugar <= 0:
                Lugar = 27 + Lugar
...
print('El mensaje desencriptado es "{0}"'.format(cadena_saliente)
